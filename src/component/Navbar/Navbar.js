...
import { MOBILE_SEARCH_BOX_SHOW, ON_SEARCH, SEARCH_BOX_CLOSE } from '../../redux/actionTypes/actionTypes';
        ...
        <div className='w-full bg-[#616161] h-12 mx-auto flex justify-between sm:px-4 px-2 items-center'>
          ...
          <div className='hidden md:flex items-center lg:gap-7 gap-3'>
            ...
            <div className='flex w-full justify-center items-center lg:gap-7 gap-3 border-r-[1px] border-l-[1px] px-3'>
              ...
              <div className='w-full cursor-pointer'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="rgba(255,255,255,1)"><path d="M16 8.24537V15.5C16 19.0899 13.0899 22 9.5 22C5.91015 22 3 19.0899 3 15.5C3 11.9101 5.91015 9 9.5 9C10.0163 9 10.5185 9.06019 11 9.17393V12.3368C10.5454 12.1208 10.0368 12 9.5 12C7.567 12 6 13.567 6 15.5C6 17.433 7.567 19 9.5 19C11.433 19 13 17.433 13 15.5V2H16C16 4.76142 18.2386 7 21 7V10C19.1081 10 17.3696 9.34328 16 8.24537Z"></path></svg>
              </div>
              <div className='w-full cursor-pointer'>
          ...
          <div
            ...
            <div onClick={() => dispatch({ type: MOBILE_SEARCH_BOX_SHOW })} className=''>

              {
                state.mobileSearch === false ?
                  <p className='text-white border-[1px] px-1 text-xs'>Phone Finder</p>
            ...
            <div className='w-7 h-7'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,255,1)"><path d="M3 4H21V6H3V4ZM3 11H21V13H3V11ZM3 18H21V20H3V18Z"></path></svg>
            </div>
          </div>
        </div>
      </div>
            ...
            <div key={i} className='absolute  w-[350px]  z-10 top-[48px] right-[44.4%] flex flex-col'>
              <Link to={`/${device.brand.toLowerCase()}/${device._id}`} className='flex justify-start items-center gap-2 bg-slate-500 border-b-[1px] border-t-[1px] py-[1px] px-2'>
                <div className='max-w-[28px] w-full'>
                  <img className='w-full h-[36px] object-contain' src={device.banner_img} alt="" srcSet="" />
                </div>
